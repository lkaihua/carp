...
✅ To navigate between folders and check files <br> ✅ To have a breadcrumb navigation bar <br> ✅ To display very long folder/file names smartly <br> ✅ To scroll smoothly when there are huge number of files <br> ✅ To have smart views for videos, images, and musics <br> ✅ Add a file size sorting option
...
- [ ] fix breadcrumbs overflow issue
- [ ] add stop signal for requesting the video files when the user leaves the page
- [ ] add text viewer: markdown/text/json etc

Nice idea

- [ ] explore: use browser API to submit thumbnail to server. debounce such operation so it won't flood the video requests

#### 2025-08-03

- [x] Separate into backend and frontend. Add dev server.
